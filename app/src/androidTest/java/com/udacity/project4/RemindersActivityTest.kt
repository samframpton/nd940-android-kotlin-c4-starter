...
class RemindersActivityTest :
    ...
    @Test
    fun addReminder_isValid_reminderDisplayed() {
        ...
        onView(withText("testLocation")).check(matches(isDisplayed()))
        activityScenario.close()
    }

    @Test
    fun addReminder_noTitle_snackbarDisplayed() {
        val activityScenario = ActivityScenario.launch(RemindersActivity::class.java)
    ...
    @Test
    fun addReminder_noLocation_snackbarDisplayed() {
        val activityScenario = ActivityScenario.launch(RemindersActivity::class.java)
        onView(withId(R.id.noDataTextView)).check(matches(isDisplayed()))
        onView(withId(R.id.addReminderFAB)).perform(click())
        onView(withId(R.id.reminderTitle)).perform(replaceText("testTitle"))
